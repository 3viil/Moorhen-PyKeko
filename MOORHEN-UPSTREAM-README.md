# Upstream Moorhen README

> This is the original README from [moorhen-coot/Moorhen](https://github.com/moorhen-coot/Moorhen),
> preserved here for attribution and reference. PyKeko-specific docs live in
> [README.md](README.md) and [README-MH.md](README-MH.md).
